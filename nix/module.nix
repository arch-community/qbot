    ...
    in
    {
      ...
      config =
        ...
        in
        {
          ...
          arch = {
            mirror =
              mkOpt' str "Mirror server hosting Arch Linux repos" "https://mirrors.edge.kernel.org/archlinux/"
                { };

            repos = mkOpt' (listOf str) "List of repositories to index" [ "core" "extra" "multilib" ] { };
          };
          ...
          my_repo = mkOpt' str "The bot's VCS repository" "https://github.com/arch-community/qbot" { };
