...
module ColorLib
  ...
  def ColorLib.ciede2000(lab1, lab2)
    # TODO: write this
    return cie76(lab1, lab2)
  end


  def ColorLib.hex_to_lab(c)
    return xyz_to_lab(rgb_to_xyz(hex_to_rgb(c)))
  end

  def ColorLib.lab_to_hex(c)
