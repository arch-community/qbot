{
  ...
  google-apis-core = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1bss8amkhifdv9ysk23pxv3ykhk8c60myx25crrqhrl4jcgkysr8";
      type = "gem";
    };
    version = "0.2.0";
  };
  google-apis-discovery_v1 = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "01q0l1788rpfra3ydp8c676b1pl3k895qzw4xn42wp7k2khmk9hg";
      type = "gem";
    };
    version = "0.1.0";
  };
  google-apis-generator = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1k5nz97vhcpl1sj6q9rb89nxrwj9bwa4fh9dln330w53ra0ijn4v";
      type = "gem";
    };
    version = "0.1.2";
  };
  ...
  picky = {
    dependencies = ["activesupport" "multi_json" "rack_fast_escape"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1f91c0mkgg73s3rfqbrakbam5bqlj6wd5zf8vkavq9y9vxz587xg";
      type = "gem";
    };
    version = "4.31.3";
  };
  ...
  rack_fast_escape = {
    dependencies = ["url_escape"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0nlsygn1s2pmpl328r3rm7rwl2m4va8wwmvn36khf6px1ri4gry6";
      type = "gem";
    };
    version = "2009.06.24";
  };
  ...
  url_escape = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "07mmmawpg8azikbq32y6wqbwwblfdbn5h4iz3zj59a50pdryiif8";
      type = "gem";
    };
    version = "2009.06.24";
  };
