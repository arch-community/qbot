{
  ...
  google-apis-discovery_v1 = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1r8lbfvnw12hqv24gqcc0kj185pp3h5sacbgr886nbnika5zi2xd";
      type = "gem";
    };
    version = "0.3.0";
  };
  ...
  picky = {
    ...
    source = {
      fetchSubmodules = false;
      rev = "7c513f045db23a7d834a6735dea83acf04599659";
      sha256 = "0994zwdiv7xrmhavah3nh0ph8s7gqqv1hq7xqdvswx3ixr5ifl6p";
      type = "git";
      url = "https://github.com/floere/picky.git";
    };
    version = "4.31.3";
  };
  pluralkit-api = {
